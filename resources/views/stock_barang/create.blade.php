...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1 class="m-0">Tambah Data stock barang</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Data stock barang</div>
                <div class="card-body">
                    <form action="{{route('stockbarang.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
